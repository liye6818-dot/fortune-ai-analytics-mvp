...
const CORE_ASSETS = [
  ...
  "./app.js?v=20260703_pwa_1",
  "./main.js?v=20260703_pwa_1",
...
async function networkFirst(request) {
  ...
  try {
    ...
    return (await cache.match(request)) || cache.match("./index.html?v=20260703_pwa_1") || cache.match("./offline.html?v=20260703_pwa_1");
  }
}
