const PWA_VERSION = "20260706_customer_region";
...
const CORE_ASSETS = [
  ...
  "./app.js?v=20260706_customer_region",
  "./main.js?v=20260706_customer_region",
...
async function networkFirst(request) {
  ...
  try {
    ...
    return (await cache.match(request)) || cache.match("./index.html?v=20260706_customer_region") || cache.match("./offline.html?v=20260706_customer_region");
  }
}
