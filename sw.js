const PWA_VERSION = "20260706_risk_report";
...
const CORE_ASSETS = [
  ...
  "./config.js?v=20260706_risk_report",
  "./app.js?v=20260706_risk_report",
  "./main.js?v=20260706_risk_report",
...
async function networkFirst(request) {
  ...
  try {
    ...
    return (await cache.match(request)) || cache.match("./index.html?v=20260706_risk_report") || cache.match("./offline.html?v=20260706_risk_report");
  }
}
