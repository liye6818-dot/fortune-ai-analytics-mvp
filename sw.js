const PWA_VERSION = "20260706_report_profit";
...
const CORE_ASSETS = [
  ...
  "./config.js?v=20260706_report_profit",
  "./app.js?v=20260706_report_profit",
  "./main.js?v=20260706_report_profit",
...
async function networkFirst(request) {
  ...
  try {
    ...
    return (await cache.match(request)) || cache.match("./index.html?v=20260706_report_profit") || cache.match("./offline.html?v=20260706_report_profit");
  }
}
